...
<html lang="en">
  ...
  <body>
    <h1 class="text-center">Uang Masuk</h1>
    <div class="mt-3">
        <a href="/tambahuangmasuk" class="btn btn-primary">Tambah Penabung</a>
    </div>
    <div class="row mt-3">
        <div class="container">
                ...
                <tbody>
                    ...
                    @foreach ($uangmasuk as $row)
                        <tr>
                            ...
                            <td>
                                <a href="/edituangmasuk/{{ $row->id }}" class="btn btn-success mb-1"><i
                                        class="fas fa-pencil-alt"></i>Edit</a><br>
                                <a href="/hapusuangmasuk/{{ $row->id }}" class="btn btn-danger"
